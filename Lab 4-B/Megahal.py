...
class Predictor:
    """The basic Megahal second- and triple-guesser.    Maintains stats on the
...
class Megahal:
    ...
    def move(self, them):
        """The main megahal "move" function."""
...
def megahal_agent(observation, configuration):
    global megahal
    if observation.step == 0:
        megahal = Megahal()
        act = megahal.move(-1)
    else:
        act = megahal.move(observation.lastOpponentAction)
