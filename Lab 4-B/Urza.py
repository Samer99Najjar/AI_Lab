...
class Predictor:
    """The basic urza second- and triple-guesser.    Maintains stats on the
...
def urza_agent(observation, configuration):
    global urza
    if observation.step == 0:
        urza = Urza()
        act = urza.move(-1)
    else:
        act = urza.move(observation.lastOpponentAction)
